...
describe('testing with no validators', function () {

    describe('check if text is in generated md', function () {
        ...
        it('check generated file', function (done) {
          this.md.generate(function (err, mdText) {
            ...
            mdText.should.match(/   - \[get\]\(#methods.books.get\)/);
        ...
        it('check test generated file', function (done) {
          var md2 = new Markdown({ templateFileName : './test/repeat.nunjucks' });
        ...
        it('check not exists file', function (done) {
